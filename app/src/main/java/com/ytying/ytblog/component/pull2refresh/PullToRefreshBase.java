...
import com.ytying.ytblog.component.pull2refresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public boolean ismPullRefreshEnabled() {
        return mPullRefreshEnabled;
    }

    public void setmPullRefreshEnabled(boolean mPullRefreshEnabled) {
        this.mPullRefreshEnabled = mPullRefreshEnabled;
    }

    public boolean ismPullLoadEnabled() {
        return mPullLoadEnabled;
    }

    public void setmPullLoadEnabled(boolean mPullLoadEnabled) {
        this.mPullLoadEnabled = mPullLoadEnabled;
    }
