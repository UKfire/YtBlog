...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    private String mNoMoreDataHint="没有更多了";
    /**
     * 构造方法
     * 
    ...
    public void setState(State state) {
        Log.v("b"+getmNoMoreDataHint(),"xxxx2v");
        if (mCurState != state) {
            mPreState = mCurState;
            mCurState = state;
    ...
    protected void onStateChanged(State curState, State oldState) {
        ...
        case REFRESHING:
            ...
            break;
        case NO_MORE_DATA:
            Log.v("c"+getmNoMoreDataHint(),"xxxx2v");
            onNoMoreData();
            break;
        default:
            break;
    ...
    public String getmNoMoreDataHint() {
        return mNoMoreDataHint;
    }

    public void setmNoMoreDataHint(String mNoMoreDataHint) {
        this.mNoMoreDataHint = mNoMoreDataHint;
    }
}
